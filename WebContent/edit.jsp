...
<body>
	...
	<form action="<c:url value='/CustomerServlet'/>" method="post">
		<input type="hidden" name="method" value="edit" /> <input
			type="hidden" name="cid" value="${customer.cid}" />
		<table border="0" align="center" width="40%"
			style="margin-left: 100px;">
			<tr>
				<td width="100px">客户名称</td>
				<td width="40%"><input type="text" name="cname"
			...
			<tr>
				...
				<td><input type="text" name="birthday" id="birthday"
					readonly="readonly" value="${customer.birthday}" /></td>
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" value="编辑客户" onclick="add()" /> <input
